import sqlite3
db = sqlite3.connect('C:\\Users\\Nick\\Dropbox\\NR22100004824\\Software Engineer Bootcamp\\T48\\ebookstore.db')
cursor = db.cursor()  
...
def EnterBook():
    cursor = db.cursor()
    id = input(str("Enter the book ID: "))
    Title = input("Enter the book title: ")
    Author = input("Enter the author's name: ")
    Qty = input(str("Enter the quantity of " + Title + " books that are in stock: "))
...
def UpdateBook ():
    cursor = db.cursor()
    Title = input(str("Please enter the title of the book you would like to update: "))
    ...
    #Updating the quantity of stock
        ...
        Qty = input(str("Please enter the quantity of \"" + Title + "\" that is currently in stock: "))
...
def DeleteBook ():
    cursor = db.cursor()
    id = input(str("Please enter the ID number of the book you want to delete: "))
...
def SearchBook ():
    ...
    if searchkey == "ID":
        id = input(str("Please enter the ID number of the book you are looking for : "))
...
#Making a menu and calling on the functions
...
print(" ")
action = input("Please enter the number that corresponds with the action you want to perform : ")
action = action.upper()
